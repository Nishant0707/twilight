...
import Banner from "../components/Assess/Banner";
import PageWrapper from "../components/Layout/PageWrapper"; // Import PageWrapper here
...
const Assessment = () => {
  ...
  return (
    <PageWrapper>
      <Box bg="white" color="gray.800" minH="100vh" py={{ base: 8, md: 12 }}>
        {/* Banner */}
        <Banner />
        ...
        {/* Stats Cards Grid */}
        <SimpleGrid columns={{ base: 1, sm: 2, md: 3 }} spacing={10} mt={20} mb={20} maxW="1000px" mx="auto">
